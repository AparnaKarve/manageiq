class HostController < ApplicationController
  ...
  def host_form_fields
    ...
    host_hash = {
      ...
      :default_password_exists => host.authentication_password.blank? ? false : true,
      ...
      :remote_password_exists => host.has_authentication_type?(:remote) ? host.authentication_password(:remote).blank? ? false : true : "",
      ...
      :ws_password_exists => host.has_authentication_type?(:ws) ? host.authentication_password(:ws).blank? ? false : true : "",
      ...
      :ipmi_password_exists =>host.has_authentication_type?(:ipmi) ? host.authentication_password(:ipmi).blank? ? false : true : "",
